...
function iniliatizeSlider() {
  ...
  for (let car in carsObject) {
    ...
    if (x <= 5) {
      ...
      <div class="product-Details prodHovr col" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#orderNowModal"
      data-bs-whatever="${carsObject[car].menuID}" onclick='orderNow("${carsObject[car].menuID}")'>
